...
// this file should not be modified. add additional properties to the properties file
// to run a subset of the cucumber feature files, modify the cucumber.features property in the properties file

@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("edu/usc/csci310/hw/webappdev")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "edu.usc.csci310.hw.webappdev")
